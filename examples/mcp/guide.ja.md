...
- `searchable-mcp/target/searchable-mcp-1.0.0-SNAPSHOT.jar`
...
```bash
java -jar searchable-mcp/target/searchable-mcp-1.0.0-SNAPSHOT.jar \
...
```json
{
  "mcpServers": {
    "searchable": {
      ...
      "args": [
        "-jar",
        "/absolute/path/to/searchable-mcp-1.0.0-SNAPSHOT.jar",
        "--config",
