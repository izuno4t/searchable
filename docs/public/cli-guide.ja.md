...
(設計判断は [docs/devel/adr/0001-cli-executable-jar-with-shade-plugin.md](adr/0001-cli-executable-jar-with-shade-plugin.md)
...
[docs/devel/design/architecture/overview.md §5.7](architecture.md)):
...
- [docs/public/setup-guide.md](setup-guide.md) — 設定ファイルの記法
- [docs/public/usage.ja.md](usage.ja.md) — ライブラリとしての利用
- [docs/devel/design/architecture/overview.md](architecture.md) — ストレージレイヤーと構成
