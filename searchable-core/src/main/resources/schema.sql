...
-- Authoritative per-document registry. Holds document-level attributes
-- (title, free-form metadata, indexed-at) that used to live as Lucene
-- stored fields on every chunk. See docs/architecture.md §5.7.
